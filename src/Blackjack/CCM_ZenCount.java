...
//for more information visit https://www.onlineblackjackrealmoney.org/card-counting/zen-count

public class CCM_ZenCount {
    int runningCount = 0;
    int trueCount = 0;
    ...
    CCM_ZenCount(double startingBankRoll, double minBet, int betSpread) {
